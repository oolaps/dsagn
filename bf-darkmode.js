 ...
 document.querySelectorAll('#darkmode').forEach(trigger => {
  trigger.addEventListener('click', function(){ 
    ...
    if(this.x){ 
      ...
      document.querySelectorAll('.flag-menu-link').forEach(target => target.classList.add('is-dark'));  
      ...
      document.querySelectorAll('.flag-menu-link').forEach(target => target.classList.remove('is-dark'));
